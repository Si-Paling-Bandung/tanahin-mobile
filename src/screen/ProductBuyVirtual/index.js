    ...
    return (
        <VStack pt={"30px"} bg={"white"} h={"full"}>
            ...
            <VStack px={'25px'}>
                ...
                <HStack py={3} display={'flex'} justifyContent={'space-between'} alignItems={'center'}>
                    <HStack alignItems={'center'} justifyContent={'space-between'}>
                        <Text ml={'2'} flex={1}>Transfer Bank</Text>
                        <Icon as={<BCA />} />
                    </HStack>
                </HStack>
            </VStack>
            ...
            <Stack px={'25px'} flex={"1"} py={'20px'}>
                <Stack mt={'auto'}>
                    <Text fontWeight={'semibold'}>By clicking the button below, you agree to the</Text>
                    <Text fontWeight={'semibold'} color={'#4FAE3A'}>Terms and Conditions and Privacy Policy</Text>
                    <Button variant={'solid'} bg={'#4FAE3A'} mt={'10px'} onPress={() => navigation.navigate('ProductBuySuccess')}>Pay Now</Button>
                </Stack>
            </Stack>
            {/* akhir transfer */}
        </VStack>
